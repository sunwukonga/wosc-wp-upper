...
class HeaderTopMenu extends HeaderType {
	...
	public function __construct() {
		...
		if ( ! is_admin() ) {
			$this->logoAreaHeight     = mrseo_elated_set_default_logo_height_for_header_types();
	...
	public function loadTemplate( $parameters = array() ) {
		...
		$parameters['logo_area_in_grid'] = mrseo_elated_get_meta_field_intersect( 'logo_area_in_grid', $id ) == 'yes' ? true : false;
		$parameters['menu_area_in_grid'] = mrseo_elated_get_meta_field_intersect( 'menu_area_in_grid', $id ) == 'yes' ? true : false;
		
		$parameters = apply_filters( 'mrseo_elated_header_top_menu_parameters', $parameters );
	...
	public function calculateHeightOfTransparency() {
		...
		$logo_background_color             = mrseo_elated_options()->getOptionValue( 'logo_area_background_color' );
		$logo_background_transparency      = mrseo_elated_options()->getOptionValue( 'logo_area_background_transparency' );
		$logo_grid_background_color        = mrseo_elated_options()->getOptionValue( 'logo_area_grid_background_color' );
		$logo_grid_background_transparency = mrseo_elated_options()->getOptionValue( 'logo_area_grid_background_transparency' );
	...
	public function calculateHeightOfCompleteTransparency() {
		...
		if ( $logoAreaTransparent || $menuAreaTransparent ) {
			if ( $logoAreaTransparent ) {
				...
				if ( mrseo_elated_is_top_bar_enabled() && mrseo_elated_is_top_bar_completely_transparent() ) {
					$transparencyHeight += mrseo_elated_get_top_bar_height();
				}
			}
