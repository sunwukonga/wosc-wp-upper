...
<div class="eltdf-pli-image">
    ...
    <?php if (!empty($switch_featured_image)) {
        ...
        <?php } else {
            $thumb_image_size = mrseo_elated_get_image_size($thumb_size);
            echo mrseo_elated_generate_thumbnail(null, $switch_featured_image, $thumb_image_size['width'], $thumb_image_size['height']);
        }
    } ?>
</div>