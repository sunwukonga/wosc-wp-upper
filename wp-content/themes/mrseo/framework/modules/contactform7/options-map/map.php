...
if ( ! function_exists('mrseo_elated_contact_form_7_options_map') ) {

	function mrseo_elated_contact_form_7_options_map() {

		mrseo_elated_add_admin_page(array(
			'slug'	=> '_contact_form7_page',
			'title'	=> esc_html__('Contact Form 7', 'mrseo'),
			'icon'	=> 'fa fa-envelope-o'
		));

		$panel_contact_form_style_1 = mrseo_elated_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_1',
			'title'	=> esc_html__('Custom Style 1', 'mrseo')
		));

		//Text Typography

		$typography_text_group = mrseo_elated_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'mrseo'),
			'description'	=> esc_html__('Setup typography for form elements text', 'mrseo'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_text_row1 = mrseo_elated_add_admin_row(array(
		...
		mrseo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Text Color', 'mrseo'),
		));
		...
		$typography_text_row2 = mrseo_elated_add_admin_row(array(
		...
		$typography_text_row3 = mrseo_elated_add_admin_row(array(
		...
		$typography_label_group = mrseo_elated_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'mrseo'),
			'description'	=> esc_html__('Setup typography for form elements label', 'mrseo'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_label_row1 = mrseo_elated_add_admin_row(array(
		...
		$typography_label_row2 = mrseo_elated_add_admin_row(array(
		...
		$background_border_group = mrseo_elated_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'mrseo'),
			'description'	=> esc_html__('Setup form elements background and border style', 'mrseo'),
			'parent'		=> $panel_contact_form_style_1
		));

		$background_border_row1 = mrseo_elated_add_admin_row(array(
		...
		mrseo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Color', 'mrseo')
		));
		...
		mrseo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Transparency', 'mrseo')
		));

		$background_border_row2 = mrseo_elated_add_admin_row(array(
		...
		mrseo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Color', 'mrseo')
		));
		...
		mrseo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Transparency', 'mrseo')
		));

		$background_border_row3 = mrseo_elated_add_admin_row(array(
		...
		mrseo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Width', 'mrseo'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		mrseo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Radius', 'mrseo'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$padding_group = mrseo_elated_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'mrseo'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_1
		));

		$padding_row = mrseo_elated_add_admin_row(array(
			'name'		=> 'padding_row',
		...
		mrseo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Top', 'mrseo'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		mrseo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Right', 'mrseo'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		mrseo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Bottom', 'mrseo'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		mrseo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Left', 'mrseo'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$margin_group = mrseo_elated_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'mrseo'),
			'description'	=> esc_html__('Setup form elements margin', 'mrseo'),
			'parent'		=> $panel_contact_form_style_1
		));

		$margin_row = mrseo_elated_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		mrseo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Textarea Height', 'mrseo'),
			'description'	=> esc_html__('Enter height for textarea form element', 'mrseo'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$button_typography_group = mrseo_elated_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'mrseo'),
			'description'	=> esc_html__('Setup button text typography', 'mrseo'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_typography_row1 = mrseo_elated_add_admin_row(array(
		...
		$button_typography_row2 = mrseo_elated_add_admin_row(array(
		...
		$button_background_border_group = mrseo_elated_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'mrseo'),
			'description'	=> esc_html__('Setup button background and border style', 'mrseo'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_background_border_row1 = mrseo_elated_add_admin_row(array(
		...
		mrseo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Color', 'mrseo')
		));
		...
		mrseo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Transparency', 'mrseo')
		));

		$button_background_border_row2 = mrseo_elated_add_admin_row(array(
		...
		mrseo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Color', 'mrseo')
		));
		...
		mrseo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Transparency', 'mrseo')
		));

		$button_background_border_row3 = mrseo_elated_add_admin_row(array(
		...
		mrseo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Height', 'mrseo'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		mrseo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Left/Right Padding', 'mrseo'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$panel_contact_form_style_2 = mrseo_elated_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'mrseo')
		));
        ...
        $panel_contact_form_style_3 = mrseo_elated_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'mrseo')
        ));
        ...
        $typography_label_row3 = mrseo_elated_add_admin_row(array(
        ...
        $button_typography_row3 = mrseo_elated_add_admin_row(array(
	...
	add_action( 'mrseo_elated_options_map', 'mrseo_elated_contact_form_7_options_map', 23);
}