...
if (!class_exists('MrSeoElatedSidebar')) {
    ...
    class MrSeoElatedSidebar
    {
        ...
        function load_assets() {
            ...
            wp_enqueue_script('eltdf_sidebar', ELATED_ROOT . '/framework/admin/assets/js/eltdf-sidebar.js');
            wp_enqueue_style('eltdf_sidebar', ELATED_ROOT . '/framework/admin/assets/css/eltdf-sidebar.css');
        }
