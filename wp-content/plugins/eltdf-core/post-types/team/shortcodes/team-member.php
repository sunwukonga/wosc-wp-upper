...
class TeamMember implements Lib\ShortcodeInterface {
    ...
    public function vcMap() {
        if(function_exists('vc_map')) {
	        vc_map( array(
			        'name'                      => esc_html__( 'Elated Team Member', 'eltdf-core' ),
			        'base'                      => $this->getBase(),
			        ...
			        'params'                    => array(
                        array(
                            ...
                            'heading'     => esc_html__('Team Layout', 'eltdf-core'),
                            'value'       => array(
                        ...
                        array(
					        ...
					        'heading'    => esc_html__( 'Select Team Member', 'eltdf-core' ),
					        'settings'   => array(
						        'sortable'      => true,
						        'unique_values' => true
					        ),
    ...
    public function render($atts, $content = null) {
        ...
        $html = eltdf_core_get_cpt_shortcode_module_template_part('team', 'team-template-'.$params['team_member_layout'], '', $params);
