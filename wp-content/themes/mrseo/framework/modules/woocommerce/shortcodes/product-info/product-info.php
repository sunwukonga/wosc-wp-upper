    ...
    */
	...
	public function getItemRatingHtml($params){
		...
		if (get_option('woocommerce_enable_review_rating') !== 'no') {
			...
			$html = '<div class="eltdf-pi-rating" title="'.sprintf(esc_html__("Rated %s out of 5", "mrseo"), $average ).'" '.mrseo_elated_get_inline_style($product_info_style).'><span style="width:'.(($average / 5)*100).'%"></span></div>';
		}
