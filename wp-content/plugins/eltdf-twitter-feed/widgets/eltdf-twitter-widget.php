		...
		if ( $twitter_api->hasUserConnected() ) {
			...
			if ( $response->status ) {
				if ( is_array( $response->data ) && count( $response->data ) ) { ?>
					<ul class="eltdf-twitter-widget <?php echo esc_attr( $holder_classes ); ?>" <?php echo mrseo_elated_get_inline_attrs( $slider_data ); ?>>
						<?php foreach ( $response->data as $tweet ) { ?>
							
							<?php if ( $type_of_widget == 'slider' ) { ?>
								
								<li class="eltdf-tweet-holder">
									<div class="eltdf-tweet-text" <?php mrseo_elated_inline_style( $twitter_style ); ?>>
			...
			esc_html_e( 'It seams that you haven\'t connected with your Twitter account', 'eltdf' );
		}
