...
if ( ! function_exists( 'mrseo_elated_get_hide_dep_for_header_main_menu_options' ) ) {
	function mrseo_elated_get_hide_dep_for_header_main_menu_options() {
		$hide_dep_options = apply_filters( 'mrseo_elated_header_main_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'mrseo_elated_header_main_navigation_options_map' ) ) {
	function mrseo_elated_header_main_navigation_options_map() {
		$hide_dep_options = mrseo_elated_get_hide_dep_for_header_main_menu_options();
		
		$panel_main_menu = mrseo_elated_add_admin_panel(
			array(
				'title'           => esc_html__( 'Main Menu', 'mrseo' ),
		...
		mrseo_elated_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Main Menu General Settings', 'mrseo' )
			)
		);
		...
		$drop_down_group = mrseo_elated_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Choose a color and transparency for the main menu background (0 = fully transparent, 1 = opaque)', 'mrseo' )
			)
		);
		
		$drop_down_row1 = mrseo_elated_add_admin_row(
			array(
		...
		mrseo_elated_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Main Dropdown Menu Appearance', 'mrseo' ),
				'description'   => esc_html__( 'Choose appearance for dropdown menu', 'mrseo' ),
				'options'       => array(
					'dropdown-default'        => esc_html__( 'Default', 'mrseo' ),
					'dropdown-animate-height' => esc_html__( 'Animate Height', 'mrseo' )
				)
			)
		);
		...
		mrseo_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dropdown Position', 'mrseo' ),
				'description'   => esc_html__( 'Enter value in percentage of entire header height', 'mrseo' ),
				'args'          => array(
					'col_width' => 3,
					'suffix'    => '%'
				)
		...
		$first_level_group = mrseo_elated_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Define styles for 1st level in Top Navigation Menu', 'mrseo' )
			)
		);
		...
		mrseo_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Hover Text Color', 'mrseo' ),
			)
		);
		...
		mrseo_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Active Text Color', 'mrseo' ),
			)
		);
		
		$first_level_row4 = mrseo_elated_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		mrseo_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Hover Text Color', 'mrseo' ),
			)
		);
		...
		mrseo_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Active Text Color', 'mrseo' ),
			)
		);
		
		$first_level_row5 = mrseo_elated_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row6 = mrseo_elated_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row7 = mrseo_elated_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		mrseo_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left/Right', 'mrseo' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		mrseo_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Left/Right', 'mrseo' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$second_level_group = mrseo_elated_add_admin_group(
			array(
				...
				'title'       => esc_html__( '2nd Level Menu', 'mrseo' ),
				'description' => esc_html__( 'Define styles for 2nd level in Top Navigation Menu', 'mrseo' )
			)
		);
		...
		$second_level_wide_group = mrseo_elated_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'second_level_wide_group',
				'title'       => esc_html__( '2nd Level Wide Menu', 'mrseo' ),
				'description' => esc_html__( 'Define styles for 2nd level in Wide Menu', 'mrseo' )
			)
		);
		
		$second_level_wide_row1 = mrseo_elated_add_admin_row(
			array(
		...
		$second_level_wide_row2 = mrseo_elated_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$second_level_wide_row3 = mrseo_elated_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$third_level_group = mrseo_elated_add_admin_group(
			array(
				...
				'title'       => esc_html__( '3nd Level Menu', 'mrseo' ),
				'description' => esc_html__( 'Define styles for 3nd level in Top Navigation Menu', 'mrseo' )
			)
		);
		...
		$third_level_row3 = mrseo_elated_add_admin_row(
			array(
				'parent' => $third_level_group,
		...
		$third_level_wide_group = mrseo_elated_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_wide_group',
				'title'       => esc_html__( '3rd Level Wide Menu', 'mrseo' ),
				'description' => esc_html__( 'Define styles for 3rd level in Wide Menu', 'mrseo' )
			)
		);
		
		$third_level_wide_row1 = mrseo_elated_add_admin_row(
			array(
		...
		$third_level_wide_row2 = mrseo_elated_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
		...
		$third_level_wide_row3 = mrseo_elated_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
	...
	add_action( 'mrseo_elated_header_main_navigation_options_map', 'mrseo_elated_header_main_navigation_options_map', 10, 1 );
}