...
if( !function_exists('mrseo_elated_get_blog_single_holder_classes') ) {
    /**
     * Function that generates blog holder classes for single blog page
     */
    function mrseo_elated_get_blog_single_holder_classes($classes) {
    ...
    add_filter( 'mrseo_elated_blog_single_holder_classes', 'mrseo_elated_get_blog_single_holder_classes' );
}
