<?php
$gallery_classes = '';
$number_of_columns = mrseo_elated_get_meta_field_intersect('portfolio_single_gallery_columns_number');
if(!empty($number_of_columns)) {
	$gallery_classes .= ' eltdf-ps-'.$number_of_columns.'-columns';
}
$space_between_items = mrseo_elated_get_meta_field_intersect('portfolio_single_gallery_space_between_items');
