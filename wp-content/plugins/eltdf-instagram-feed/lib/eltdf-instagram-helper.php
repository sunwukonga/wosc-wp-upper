...
/**
 * Class ElatedInstagramHelper
 */
class ElatedInstagramHelper {
    /**
     * Generates HTML for given image from Instagram feed. Defines eltdf_instagram_image_atts filter
    ...
    public function getImageHTML($image, $imageSize) {
        ...
        $imageAtts = apply_filters('eltdf_instagram_image_atts',
            array(
                'class' => $imageSize,
